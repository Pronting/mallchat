...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setParent("priv.pront.mallchat.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("2eb1a8849354b43b");
        dataSourceConfig.setUrl("jdbc:mysql://45.204.4.13:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
