package priv.pront.mallchat.common.chat.domain.entity;
...
import priv.pront.mallchat.common.chat.domain.enums.RoomTypeEnum;
...
public class Room implements Serializable {
     ...
     * 房间类型 1群聊 2单聊
     *
     * @see priv.pront.mallchat.common.chat.domain.enums.RoomTypeEnum
     */
    @TableField("type")
     ...
     * 是否全员展示 0否 1是
     *
     * @see priv.pront.mallchat.common.chat.domain.enums.HotFlagEnum
     */
    @TableField("hot_flag")
